...
clf_edge_pred_from_emb = LogisticRegression(verbose=0, solver="lbfgs",
                                            multi_class="auto", max_iter=100 ) #max_iter=500)

clf_edge_pred_from_emb.fit(in_sample_edge_feat_from_emb, in_sample_edge_end_indices)
...
roc_auc_val = roc_auc_score(out_of_sample_edge_end_indices, edge_pred_from_emb[:, positive_class_index])
